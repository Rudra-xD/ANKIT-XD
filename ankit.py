...
def contact():
	...
	os.system('xdg-open https://www.facebook.com/profile.php?id=100093795855866')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[ANKIT-XD]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
